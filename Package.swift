...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/BudhirajaRajesh/NuggetInternalDependency/releases/download/1.0.0-NuggetFoundation/NuggetFoundation.xcframework.zip",
            checksum: "69ded32bf6c31cb0aed9b1b87186f8ebafb2f06ddf444f2efcee2557ae979a75"
        ),
        .binaryTarget(
            name: "NuggetJumbo",
            url: "https://github.com/BudhirajaRajesh/NuggetInternalDependency/releases/download/1.0.0-NuggetJumbo/NuggetJumbo.xcframework.zip",
            checksum: "b6eba3873ea023c60c012f2c5db1f2bd072f949189be20c091da5720f80c8f98"
        ),
        .binaryTarget(
            name: "NuggetApiManager",
            url: "https://github.com/BudhirajaRajesh/NuggetInternalDependency/releases/download/1.0.0-NuggetAPIManager/ZApiManager.xcframework.zip",
